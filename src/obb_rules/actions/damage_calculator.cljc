...
(defn distance-factor
  ...
  [attacker target]
    (let [[x1 y1] (element/element-coordinate attacker)
          [x2 y2] (element/element-coordinate target)
...
(defn damage
  ...
  (let [attacker-quantity (element/element-quantity attacker-element)
        attack (element/element-attack board attacker-element defender-element)
...
(defn defense
  ...
  [board attacker-element defender-element]
  (element/element-defense board attacker-element defender-element))
...
(defn destroyed-with-unused-damage
  ...
  ([board attacker-element defender-element total-damage]
   (let [elem-defense (defense board attacker-element defender-element)
         ...
         defender-quantity (element/element-quantity defender-element)]
