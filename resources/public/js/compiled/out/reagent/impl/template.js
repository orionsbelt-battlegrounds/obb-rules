...
var G__42021 = o;
(G__42021[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
while (G__42023__i < G__42023__a.length) {G__42023__a[G__42023__i] = arguments[G__42023__i + 0]; ++G__42023__i;}
  args = new cljs.core.IndexedSeq(G__42023__a,0);
} 
...
var old_42025 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_42025))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_42025)].join(''):class$));
} else {
}
...
var G__42028 = jsprops;
(G__42028["defaultValue"] = value);

(G__42028["onChange"] = ((function (G__42028,v,value,on_change){
return (function (p1__42026_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__42026_SHARP_);
});})(G__42028,v,value,on_change))
);
...
var vec__42030 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__42030,(0),null);
var id = cljs.core.nth.call(null,vec__42030,(1),null);
var class$ = cljs.core.nth.call(null,vec__42030,(2),null);
...
var temp__4659__auto__ = (function (){var G__42034 = cljs.core.meta.call(null,v);
if((G__42034 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__42034);
}
})();
if((temp__4659__auto__ == null)){
...
var jsprops = {"argv": v};
var G__42036_42037 = v;
var G__42036_42038__$1 = (((G__42036_42037 == null))?null:reagent.impl.template.key_from_vec.call(null,G__42036_42037));
if((G__42036_42038__$1 == null)){
} else {
(jsprops["key"] = G__42036_42038__$1);
}
...
var p = (function (){var temp__4659__auto__ = (function (){var G__42041 = cljs.core.meta.call(null,argv);
if((G__42041 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__42041);
}
})();
if((temp__4659__auto__ == null)){
return jsprops;
...
var G__42042 = (((jsprops == null))?{}:jsprops);
(G__42042["key"] = key);
...
var G__42043 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__42043;
continue;
}
} else {
...
var n__19273__auto___42044 = a.length;
var i_42045 = (0);
while(true){
if((i_42045 < n__19273__auto___42044)){
(a[i_42045] = reagent.impl.template.as_element.call(null,(a[i_42045])));

var G__42046 = (i_42045 + (1));
i_42045 = G__42046;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__19273__auto___42047 = a.length;
var i_42048 = (0);
while(true){
if((i_42048 < n__19273__auto___42047)){
var val_42049 = (a[i_42048]);
if((cljs.core.vector_QMARK_.call(null,val_42049)) && ((reagent.impl.template.key_from_vec.call(null,val_42049) == null))){
(o["no-key"] = true);
} else {
}

(a[i_42048] = reagent.impl.template.as_element.call(null,val_42049));

var G__42050 = (i_42048 + (1));
i_42048 = G__42050;
continue;
} else {
}
...
var G__42052 = (cljs.core.count.call(null,argv) - first_child);
switch (G__42052) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__42052){
...
//# sourceMappingURL=template.js.map?rel=1458852295589