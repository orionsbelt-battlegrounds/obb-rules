...
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"player","player",-97687400),page)){
return obb_demo.views.player.render.call(null,state);
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"many-games","many-games",1856139136),page)){
return obb_demo.views.many_games.render.call(null,state);
} else {
...
var args46131 = [];
var len__19428__auto___46134 = arguments.length;
var i__19429__auto___46135 = (0);
while(true){
if((i__19429__auto___46135 < len__19428__auto___46134)){
args46131.push((arguments[i__19429__auto___46135]));

var G__46136 = (i__19429__auto___46135 + (1));
i__19429__auto___46135 = G__46136;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args46131.length)].join('')));
...
//# sourceMappingURL=index.js.map?rel=1458852301240