...
return (obb_rules.ai.alamo.actions.cljs$core$IFn$_invoke$arity$2 ? obb_rules.ai.alamo.actions.cljs$core$IFn$_invoke$arity$2(game,cljs.core.constant$keyword$p2) : obb_rules.ai.alamo.actions.call(null,game,cljs.core.constant$keyword$p2));
} else {
return (obb_rules.ai.firingsquad.actions.cljs$core$IFn$_invoke$arity$2 ? obb_rules.ai.firingsquad.actions.cljs$core$IFn$_invoke$arity$2(game,cljs.core.constant$keyword$p2) : obb_rules.ai.firingsquad.actions.call(null,game,cljs.core.constant$keyword$p2));
}
});
/**
 * Resets the actions on the current turn
...
var ret__8109__auto__ = obb_demo.views.player.bot_turn(game_data,game);
...
return cljs.core.name(cljs.core.first(p1__10993_SHARP_));
...
return cljs.core.name(cljs.core.first(p1__10994_SHARP_));
});})(unit,element,temp__4423__auto__))
...
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$select,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$value,(function (){var or__7199__auto__ = cljs.core.constant$keyword$bot.cljs$core$IFn$_invoke$arity$1(game_data);
if(cljs.core.truth_(or__7199__auto__)){
return or__7199__auto__;
} else {
return "Firingsquad";
