...
return obb_demo.state.set_page_data_BANG_(new cljs.core.PersistentArrayMap(null, 8, [cljs.core.cst$kw$game,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$original_DASH_game.cljs$core$IFn$_invoke$arity$1(game_data),cljs.core.cst$kw$action_DASH_results),cljs.core.cst$kw$removed_DASH_elements),cljs.core.cst$kw$original_DASH_game,cljs.core.cst$kw$original_DASH_game.cljs$core$IFn$_invoke$arity$1(game_data),cljs.core.cst$kw$previous_DASH_game,cljs.core.cst$kw$original_DASH_game.cljs$core$IFn$_invoke$arity$1(game_data),cljs.core.cst$kw$previous_DASH_player,cljs.core.cst$kw$p2,cljs.core.cst$kw$history,cljs.core.cst$kw$history.cljs$core$IFn$_invoke$arity$1(game_data),cljs.core.cst$kw$bot,cljs.core.cst$kw$bot.cljs$core$IFn$_invoke$arity$1(game_data),cljs.core.cst$kw$action_DASH_points,(0),cljs.core.cst$kw$turn_DASH_num,(0)], null));
});
...
return obb_demo.state.set_page_data_BANG_(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(game_data,cljs.core.cst$kw$game_DASH_str,ev.target.value));
});
/**
...
var game_str = cljs.core.cst$kw$game_DASH_str.cljs$core$IFn$_invoke$arity$1(game_data);
var new_game = obb_rules.serializer.reader.str__GT_game(game_str);
...
})()], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$button$btn$btn_DASH_primary,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$on_DASH_click,cljs.core.partial.cljs$core$IFn$_invoke$arity$2(obb_demo.views.player.load_game_str,game_data)], null),"Load"], null)], null);
});
