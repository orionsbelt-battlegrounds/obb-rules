...
var temp__4423__auto__ = cljs.core.cst$kw$player.cljs$core$IFn$_invoke$arity$1(state);
...
var game_data = new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$game,game,cljs.core.cst$kw$original_DASH_game,game,cljs.core.cst$kw$action_DASH_points,(0),cljs.core.cst$kw$turn_DASH_num,(0)], null);
...
var actions = (function (){var start__8137__auto__ = (new Date()).getTime();
var ret__8138__auto__ = obb_demo.views.player.bot_turn(game_data,game);
cljs.core.prn.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([[cljs.core.str("Elapsed time: "),cljs.core.str(((new Date()).getTime() - start__8137__auto__)),cljs.core.str(" msecs")].join('')], 0));

return ret__8138__auto__;
})();
...
return obb_demo.state.set_page_data_BANG_(new cljs.core.PersistentArrayMap(null, 7, [cljs.core.cst$kw$game,clean_game,cljs.core.cst$kw$original_DASH_game,new_game,cljs.core.cst$kw$previous_DASH_game,new_game,cljs.core.cst$kw$previous_DASH_player,cljs.core.cst$kw$p2,cljs.core.cst$kw$bot,cljs.core.cst$kw$bot.cljs$core$IFn$_invoke$arity$1(game_data),cljs.core.cst$kw$action_DASH_points,(0),cljs.core.cst$kw$turn_DASH_num,((1) + turn_num)], null));
} else {
...
var temp__4423__auto__ = cljs.core.cst$kw$selected_DASH_element.cljs$core$IFn$_invoke$arity$1(game_data);
if(cljs.core.truth_(temp__4423__auto__)){
...
return cljs.core.name(cljs.core.first(p1__11023_SHARP_));
});})(unit,element,temp__4423__auto__))
...
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$select,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$value,(function (){var or__7228__auto__ = cljs.core.cst$kw$bot.cljs$core$IFn$_invoke$arity$1(game_data);
if(cljs.core.truth_(or__7228__auto__)){
return or__7228__auto__;
} else {
return "Firingsquad";
