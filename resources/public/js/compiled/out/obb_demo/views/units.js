...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.panel.panel-primary","div.panel.panel-primary",-1076833638),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.panel-heading","div.panel-heading",-368913146),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h3.panel-title","h3.panel-title",530261929),cljs.core.name.call(null,category)], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.panel-body","div.panel-body",-4468178),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ul.units","ul.units",-1301352355),(function (){var iter__19142__auto__ = (function obb_demo$views$units$units_panel_$_iter__46113(s__46114){
return (new cljs.core.LazySeq(null,(function (){
var s__46114__$1 = s__46114;
while(true){
var temp__4657__auto__ = cljs.core.seq.call(null,s__46114__$1);
if(temp__4657__auto__){
var s__46114__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__46114__$2)){
var c__19140__auto__ = cljs.core.chunk_first.call(null,s__46114__$2);
var size__19141__auto__ = cljs.core.count.call(null,c__19140__auto__);
var b__46116 = cljs.core.chunk_buffer.call(null,size__19141__auto__);
if((function (){var i__46115 = (0);
while(true){
if((i__46115 < size__19141__auto__)){
var unit = cljs.core._nth.call(null,c__19140__auto__,i__46115);
cljs.core.chunk_append.call(null,b__46116,(function (){var unit_name = obb_rules.unit.unit_name.call(null,unit);
var url = [cljs.core.str("http://orionsbelt.eu/public/units/"),cljs.core.str(unit_name),cljs.core.str("_n.png")].join('');
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),unit_name], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"img","img",1442687358),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"src","src",-1651076051),url,new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__46115,unit_name,url,unit,c__19140__auto__,size__19141__auto__,b__46116,s__46114__$2,temp__4657__auto__){
return (function (){
return obb_demo.state.set_page_data_BANG_.call(null,unit_name);
});})(i__46115,unit_name,url,unit,c__19140__auto__,size__19141__auto__,b__46116,s__46114__$2,temp__4657__auto__))
,new cljs.core.Keyword(null,"alt","alt",-3214426),unit_name], null)], null)], null);
})());

var G__46117 = (i__46115 + (1));
i__46115 = G__46117;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__46116),obb_demo$views$units$units_panel_$_iter__46113.call(null,cljs.core.chunk_rest.call(null,s__46114__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__46116),null);
}
} else {
var unit = cljs.core.first.call(null,s__46114__$2);
return cljs.core.cons.call(null,(function (){var unit_name = obb_rules.unit.unit_name.call(null,unit);
var url = [cljs.core.str("http://orionsbelt.eu/public/units/"),cljs.core.str(unit_name),cljs.core.str("_n.png")].join('');
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),unit_name], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"img","img",1442687358),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"src","src",-1651076051),url,new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (unit_name,url,unit,s__46114__$2,temp__4657__auto__){
return (function (){
return obb_demo.state.set_page_data_BANG_.call(null,unit_name);
});})(unit_name,url,unit,s__46114__$2,temp__4657__auto__))
,new cljs.core.Keyword(null,"alt","alt",-3214426),unit_name], null)], null)], null);
})(),obb_demo$views$units$units_panel_$_iter__46113.call(null,cljs.core.rest.call(null,s__46114__$2)));
}
} else {
return null;
}
...
return iter__19142__auto__.call(null,obb_rules.unit.units_by_category.call(null,category));
})()], null)], null)], null);
});
...
//# sourceMappingURL=units.js.map?rel=1458852301186