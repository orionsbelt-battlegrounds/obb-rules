...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$div$panel$panel_DASH_primary,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$div$panel_DASH_heading,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$h3$panel_DASH_title,cljs.core.name(category)], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$div$panel_DASH_body,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$ul$units,(function (){var iter__7945__auto__ = (function obb_demo$views$units$units_panel_$_iter__11111(s__11112){
return (new cljs.core.LazySeq(null,(function (){
var s__11112__$1 = s__11112;
while(true){
var temp__4425__auto__ = cljs.core.seq(s__11112__$1);
if(temp__4425__auto__){
var s__11112__$2 = temp__4425__auto__;
if(cljs.core.chunked_seq_QMARK_(s__11112__$2)){
var c__7943__auto__ = cljs.core.chunk_first(s__11112__$2);
var size__7944__auto__ = cljs.core.count(c__7943__auto__);
var b__11114 = cljs.core.chunk_buffer(size__7944__auto__);
if((function (){var i__11113 = (0);
while(true){
if((i__11113 < size__7944__auto__)){
var unit = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__7943__auto__,i__11113);
cljs.core.chunk_append(b__11114,(function (){var unit_name = obb_rules.unit.unit_name(unit);
var url = [cljs.core.str("http://orionsbelt.eu/public/units/"),cljs.core.str(unit_name),cljs.core.str("_n.png")].join('');
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$li,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$key,unit_name], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$img,new cljs.core.PersistentArrayMap(null, 3, [cljs.core.constant$keyword$src,url,cljs.core.constant$keyword$on_DASH_click,((function (i__11113,unit_name,url,unit,c__7943__auto__,size__7944__auto__,b__11114,s__11112__$2,temp__4425__auto__){
return (function (){
return obb_demo.state.set_page_data_BANG_(unit_name);
});})(i__11113,unit_name,url,unit,c__7943__auto__,size__7944__auto__,b__11114,s__11112__$2,temp__4425__auto__))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__11114),obb_demo$views$units$units_panel_$_iter__11111(cljs.core.chunk_rest(s__11112__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__11114),null);
}
} else {
var unit = cljs.core.first(s__11112__$2);
return cljs.core.cons((function (){var unit_name = obb_rules.unit.unit_name(unit);
var url = [cljs.core.str("http://orionsbelt.eu/public/units/"),cljs.core.str(unit_name),cljs.core.str("_n.png")].join('');
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$li,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$key,unit_name], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$img,new cljs.core.PersistentArrayMap(null, 3, [cljs.core.constant$keyword$src,url,cljs.core.constant$keyword$on_DASH_click,((function (unit_name,url,unit,s__11112__$2,temp__4425__auto__){
return (function (){
return obb_demo.state.set_page_data_BANG_(unit_name);
});})(unit_name,url,unit,s__11112__$2,temp__4425__auto__))
,cljs.core.constant$keyword$alt,unit_name], null)], null)], null);
})(),obb_demo$views$units$units_panel_$_iter__11111(cljs.core.rest(s__11112__$2)));
}
} else {
return null;
}
...
return iter__7945__auto__(obb_rules.unit.units_by_category(category));
})()], null)], null)], null);
});
