...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div$panel$panel_DASH_primary,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div$panel_DASH_heading,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$h3$panel_DASH_title,cljs.core.name(category)], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div$panel_DASH_body,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$ul$units,(function (){var iter__6928__auto__ = (function obb_demo$views$units$units_panel_$_iter__15993(s__15994){
return (new cljs.core.LazySeq(null,(function (){
var s__15994__$1 = s__15994;
while(true){
var temp__4657__auto__ = cljs.core.seq(s__15994__$1);
if(temp__4657__auto__){
var s__15994__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_(s__15994__$2)){
var c__6926__auto__ = cljs.core.chunk_first(s__15994__$2);
var size__6927__auto__ = cljs.core.count(c__6926__auto__);
var b__15996 = cljs.core.chunk_buffer(size__6927__auto__);
if((function (){var i__15995 = (0);
while(true){
if((i__15995 < size__6927__auto__)){
var unit = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__6926__auto__,i__15995);
cljs.core.chunk_append(b__15996,(function (){var unit_name = obb_rules.unit.unit_name(unit);
var url = [cljs.core.str("http://orionsbelt.eu/public/units/"),cljs.core.str(unit_name),cljs.core.str("_n.png")].join('');
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$li,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$key,unit_name], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$img,new cljs.core.PersistentArrayMap(null, 3, [cljs.core.cst$kw$src,url,cljs.core.cst$kw$on_DASH_click,((function (i__15995,unit_name,url,unit,c__6926__auto__,size__6927__auto__,b__15996,s__15994__$2,temp__4657__auto__){
return (function (){
return obb_demo.state.set_page_data_BANG_(unit_name);
});})(i__15995,unit_name,url,unit,c__6926__auto__,size__6927__auto__,b__15996,s__15994__$2,temp__4657__auto__))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__15996),obb_demo$views$units$units_panel_$_iter__15993(cljs.core.chunk_rest(s__15994__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__15996),null);
}
} else {
var unit = cljs.core.first(s__15994__$2);
return cljs.core.cons((function (){var unit_name = obb_rules.unit.unit_name(unit);
var url = [cljs.core.str("http://orionsbelt.eu/public/units/"),cljs.core.str(unit_name),cljs.core.str("_n.png")].join('');
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$li,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$key,unit_name], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$img,new cljs.core.PersistentArrayMap(null, 3, [cljs.core.cst$kw$src,url,cljs.core.cst$kw$on_DASH_click,((function (unit_name,url,unit,s__15994__$2,temp__4657__auto__){
return (function (){
return obb_demo.state.set_page_data_BANG_(unit_name);
});})(unit_name,url,unit,s__15994__$2,temp__4657__auto__))
,cljs.core.cst$kw$alt,unit_name], null)], null)], null);
})(),obb_demo$views$units$units_panel_$_iter__15993(cljs.core.rest(s__15994__$2)));
}
} else {
return null;
}
