...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$div$panel$panel_DASH_primary,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$div$panel_DASH_heading,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$h3$panel_DASH_title,cljs.core.name(category)], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$div$panel_DASH_body,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$ul$units,(function (){var iter__7573__auto__ = (function obb_demo$views$units$units_panel_$_iter__13660(s__13661){
return (new cljs.core.LazySeq(null,(function (){
var s__13661__$1 = s__13661;
while(true){
var temp__4425__auto__ = cljs.core.seq(s__13661__$1);
if(temp__4425__auto__){
var s__13661__$2 = temp__4425__auto__;
if(cljs.core.chunked_seq_QMARK_(s__13661__$2)){
var c__7571__auto__ = cljs.core.chunk_first(s__13661__$2);
var size__7572__auto__ = cljs.core.count(c__7571__auto__);
var b__13663 = cljs.core.chunk_buffer(size__7572__auto__);
if((function (){var i__13662 = (0);
while(true){
if((i__13662 < size__7572__auto__)){
var unit = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__7571__auto__,i__13662);
cljs.core.chunk_append(b__13663,(function (){var unit_name = obb_rules.unit.unit_name(unit);
var url = [cljs.core.str("http://orionsbelt.eu/public/units/"),cljs.core.str(unit_name),cljs.core.str("_n.png")].join('');
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$li,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$key,unit_name], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$img,new cljs.core.PersistentArrayMap(null, 3, [cljs.core.constant$keyword$src,url,cljs.core.constant$keyword$on_DASH_click,((function (i__13662,unit_name,url,unit,c__7571__auto__,size__7572__auto__,b__13663,s__13661__$2,temp__4425__auto__){
return (function (){
return obb_demo.state.set_page_data_BANG_(unit_name);
});})(i__13662,unit_name,url,unit,c__7571__auto__,size__7572__auto__,b__13663,s__13661__$2,temp__4425__auto__))
,cljs.core.constant$keyword$alt,unit_name], null)], null)], null);
})());

var G__13666 = (i__13662 + (1));
i__13662 = G__13666;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__13663),obb_demo$views$units$units_panel_$_iter__13660(cljs.core.chunk_rest(s__13661__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__13663),null);
}
} else {
var unit = cljs.core.first(s__13661__$2);
return cljs.core.cons((function (){var unit_name = obb_rules.unit.unit_name(unit);
var url = [cljs.core.str("http://orionsbelt.eu/public/units/"),cljs.core.str(unit_name),cljs.core.str("_n.png")].join('');
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$li,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.constant$keyword$key,unit_name], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.constant$keyword$img,new cljs.core.PersistentArrayMap(null, 3, [cljs.core.constant$keyword$src,url,cljs.core.constant$keyword$on_DASH_click,((function (unit_name,url,unit,s__13661__$2,temp__4425__auto__){
return (function (){
return obb_demo.state.set_page_data_BANG_(unit_name);
});})(unit_name,url,unit,s__13661__$2,temp__4425__auto__))
,cljs.core.constant$keyword$alt,unit_name], null)], null)], null);
})(),obb_demo$views$units$units_panel_$_iter__13660(cljs.core.rest(s__13661__$2)));
}
} else {
return null;
}
...
return iter__7573__auto__(obb_rules.unit.units_by_category(category));
})()], null)], null)], null);
});
