...
return (function obb_demo$views$many_games$render_$_iter__16301(s__16302){
return (new cljs.core.LazySeq(null,((function (datas){
return (function (){
var s__16302__$1 = s__16302;
while(true){
var temp__4657__auto__ = cljs.core.seq(s__16302__$1);
if(temp__4657__auto__){
var s__16302__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_(s__16302__$2)){
var c__6926__auto__ = cljs.core.chunk_first(s__16302__$2);
var size__6927__auto__ = cljs.core.count(c__6926__auto__);
var b__16304 = cljs.core.chunk_buffer(size__6927__auto__);
if((function (){var i__16303 = (0);
while(true){
if((i__16303 < size__6927__auto__)){
var game_data = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__6926__auto__,i__16303);
cljs.core.chunk_append(b__16304,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div$col_DASH_lg_DASH_4,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$key,cljs.core.rand_int((10000))], null),obb_demo.views.power_bar.render(cljs.core.cst$kw$game.cljs$core$IFn$_invoke$arity$1(game_data)),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [obb_demo.boardground.render,cljs.core.PersistentArrayMap.EMPTY,game_data], null)], null));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__16304),obb_demo$views$many_games$render_$_iter__16301(cljs.core.chunk_rest(s__16302__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__16304),null);
}
} else {
var game_data = cljs.core.first(s__16302__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div$col_DASH_lg_DASH_4,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$key,cljs.core.rand_int((10000))], null),obb_demo.views.power_bar.render(cljs.core.cst$kw$game.cljs$core$IFn$_invoke$arity$1(game_data)),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [obb_demo.boardground.render,cljs.core.PersistentArrayMap.EMPTY,game_data], null)], null),obb_demo$views$many_games$render_$_iter__16301(cljs.core.rest(s__16302__$2)));
}
} else {
return null;
}
