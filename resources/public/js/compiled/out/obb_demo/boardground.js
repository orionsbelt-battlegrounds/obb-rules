...
if(cljs.core.truth_((function (){var and__6198__auto__ = element;
...
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(game_data,cljs.core.cst$kw$possible_DASH_destinations),cljs.core.cst$kw$possible_DASH_attacks),cljs.core.cst$kw$selected_DASH_coord),cljs.core.cst$kw$selected_DASH_quantity),cljs.core.cst$kw$selected_DASH_quantity_DASH_error),cljs.core.cst$kw$selected_DASH_element);
}
});
/**
...
var x__$1 = (x - (1));
return new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$left,[cljs.core.str((x__$1 * 12.5)),cljs.core.str("%")].join(''),cljs.core.cst$kw$bottom,[cljs.core.str((((8) - y) * 12.5)),cljs.core.str("%")].join('')], null);
});
/**
 ...
 *   on the main site.
 */
obb_demo.boardground.process_unit_name = (function obb_demo$boardground$process_unit_name(unit_name){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(unit_name,"star")){
return "flag";
} else {
return unit_name;
}
...
var unit_name = obb_demo.boardground.process_unit_name(obb_rules.unit.unit_name(unit));
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$img$unit,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$src,[cljs.core.str("http://orionsbelt.eu/public/units/"),cljs.core.str(unit_name),cljs.core.str("_"),cljs.core.str(obb_demo.boardground.direction(element)),cljs.core.str(".png")].join('')], null)], null);
} else {
return null;
}
});
...
var action_points = (function (){var or__6210__auto__ = cljs.core.cst$kw$action_DASH_points.cljs$core$IFn$_invoke$arity$1(game_data);
...
if(cljs.core.truth_((function (){var and__6198__auto__ = (element == null);
if(and__6198__auto__){
var and__6198__auto____$1 = !((cost == null));
if(and__6198__auto____$1){
var and__6198__auto____$2 = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(coord,cljs.core.cst$kw$overed_DASH_coord.cljs$core$IFn$_invoke$arity$1(game_data));
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$img$unit_DASH_possible_DASH_move,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$src,[cljs.core.str("http://orionsbelt.eu/public/units/"),cljs.core.str(unit_name),cljs.core.str("_"),cljs.core.str(obb_demo.boardground.direction(element__$1)),cljs.core.str(".png")].join('')], null)], null);
} else {
return null;
}
});
...
var unit = obb_rules.element.element_unit(element__$1);
var unit_name = obb_rules.unit.unit_name(unit);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$img$unit_DASH_possible_DASH_attack,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$src,"http://orionsbelt.eu/public/battle/target.gif"], null)], null);
} else {
return null;
}
});
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(player,cljs.core.cst$kw$p2)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div$enemy], null);
} else {
return null;
}
} else {
...
var temp__4655__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$possible_DASH_destinations.cljs$core$IFn$_invoke$arity$1(game_data),coord);
if(cljs.core.truth_(temp__4655__auto__)){
var cost = temp__4655__auto__;
if(cljs.core.truth_(obb_demo.boardground.possible_cost_QMARK_(game_data,cost))){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div$possible_DASH_destination], null);
} else {
return null;
}
} else {
...
var temp__4655__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$possible_DASH_attacks.cljs$core$IFn$_invoke$arity$1(game_data),coord);
if(cljs.core.truth_(temp__4655__auto__)){
var cost = temp__4655__auto__;
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div$possible_DASH_target], null);
} else {
return null;
}
});
...
if(cljs.core.truth_((function (){var or__6210__auto__ = obb_demo.boardground.selected_QMARK_(game_data,element);
if(cljs.core.truth_(or__6210__auto__)){
return or__6210__auto__;
} else {
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div$element_DASH_quantity,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [obb_demo.boardground.player_label(obb_rules.element.element_player.cljs$core$IFn$_invoke$arity$1(element)),obb_rules.element.element_quantity.cljs$core$IFn$_invoke$arity$1(element)], null)], null);
} else {
return null;
}
});
...
if(cljs.core.truth_(cljs.core.some(cljs.core.PersistentHashSet.fromArray([action_name], true),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$move,cljs.core.cst$kw$goto], null)))){
...
if(cljs.core.truth_(cljs.core.some(cljs.core.PersistentHashSet.fromArray([action_name], true),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$rotate,cljs.core.cst$kw$attack], null)))){
...
var raw_action = cljs.core.first(action_result);
var action_name = cljs.core.first(raw_action);
if(cljs.core.truth_(cljs.core.some(cljs.core.PersistentHashSet.fromArray([action_name], true),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$attack], null)))){
...
var or__6210__auto__ = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(game_data,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$game,cljs.core.cst$kw$action_DASH_results], null));
if(cljs.core.truth_(or__6210__auto__)){
return or__6210__auto__;
} else {
var or__6210__auto____$1 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(game_data,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$game,cljs.core.cst$kw$previous_DASH_action_DASH_results], null));
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div$target,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div$attacked], null)], null);
} else {
return null;
}
});
...
var and__6198__auto__ = (elem == null);
if(and__6198__auto__){
var and__6198__auto____$1 = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$selected_DASH_quantity.cljs$core$IFn$_invoke$arity$1(game_data),obb_rules.element.element_quantity.cljs$core$IFn$_invoke$arity$1(cljs.core.cst$kw$selected_DASH_element.cljs$core$IFn$_invoke$arity$1(game_data)));
if(and__6198__auto____$1){
...
var and__6198__auto__ = (elem == null);
if(and__6198__auto__){
var and__6198__auto____$1 = cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$selected_DASH_quantity.cljs$core$IFn$_invoke$arity$1(game_data),obb_rules.element.element_quantity.cljs$core$IFn$_invoke$arity$1(cljs.core.cst$kw$selected_DASH_element.cljs$core$IFn$_invoke$arity$1(game_data)));
if(and__6198__auto____$1){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$possible_DASH_destinations.cljs$core$IFn$_invoke$arity$1(game_data),coord);
} else {
return and__6198__auto____$1;
...
var current_actions = cljs.core.get.cljs$core$IFn$_invoke$arity$3(game_data,cljs.core.cst$kw$actions,cljs.core.PersistentVector.EMPTY);
var next_actions = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(current_actions,action);
...
return obb_demo.state.set_page_data_BANG_(obb_demo.boardground.with_selected_element(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.assoc_in(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(game_data,cljs.core.cst$kw$game,obb_rules.result.result_board(result)),cljs.core.cst$kw$action_DASH_points,obb_rules.result.result_cost(result)),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$game,cljs.core.cst$kw$history], null),cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.vec(cljs.core.cst$kw$history.cljs$core$IFn$_invoke$arity$1(game_data)),new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$player,player,cljs.core.cst$kw$actions,next_actions], null))),cljs.core.cst$kw$actions,next_actions),coord));
} else {
...
var action = new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$move,selected_coord,coord,quantity], null);
...
var selected_coord = cljs.core.cst$kw$selected_DASH_coord.cljs$core$IFn$_invoke$arity$1(game_data);
var player = obb_rules.element.element_player.cljs$core$IFn$_invoke$arity$1(cljs.core.cst$kw$selected_DASH_element.cljs$core$IFn$_invoke$arity$1(game_data));
var action = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$goto,selected_coord,coord], null);
return obb_demo.boardground.register_action(game_data,game,player,action,coord);
});
/**
...
var and__6198__auto__ = !((elem == null));
if(and__6198__auto__){
var and__6198__auto____$1 = cljs.core.not(obb_rules.element.frozen_QMARK_(elem));
if(and__6198__auto____$1){
...
var selected_coord = cljs.core.cst$kw$selected_DASH_coord.cljs$core$IFn$_invoke$arity$1(game_data);
var player = obb_rules.element.element_player.cljs$core$IFn$_invoke$arity$1(cljs.core.cst$kw$selected_DASH_element.cljs$core$IFn$_invoke$arity$1(game_data));
var action = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$attack,selected_coord,coord], null);
...
return obb_demo.state.set_page_data_BANG_(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(game_data,cljs.core.cst$kw$overed_DASH_coord,coord),cljs.core.cst$kw$overed_DASH_element,elem));
});
/**
...
return new cljs.core.PersistentVector(null, 12, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div$obb_DASH_square,new cljs.core.PersistentArrayMap(null, 5, [cljs.core.cst$kw$on_DASH_click,square_clicked,cljs.core.cst$kw$on_DASH_touch_DASH_start,square_clicked,cljs.core.cst$kw$on_DASH_mouse_DASH_over,cljs.core.partial.cljs$core$IFn$_invoke$arity$variadic(obb_demo.boardground.square_overed,game_data,game,coord,cljs.core.array_seq([element], 0)),cljs.core.cst$kw$key,[cljs.core.str(x),cljs.core.str(y)].join(''),cljs.core.cst$kw$style,square_style], null),obb_demo.boardground.unit_image(game,element),obb_demo.boardground.possible_move(game_data,coord,element),obb_demo.boardground.possible_attack(game_data,coord,element),obb_demo.boardground.selected_display(game_data,element),obb_demo.boardground.possible_destination(game_data,coord),obb_demo.boardground.action_participant(game_data,coord),obb_demo.boardground.attacked(game_data,coord,element),obb_demo.boardground.possible_target(game_data,coord),obb_demo.boardground.element_quantity(game_data,element),obb_demo.boardground.enemy_display(game,element)], null);
});
/**
 * Gets the panel size stype
 */
obb_demo.boardground.boardground_size = (function obb_demo$boardground$boardground_size(options){
return cljs.core.cst$kw$boardground_DASH_style.cljs$core$IFn$_invoke$arity$1(options);
});
/**
...
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div$obb_DASH_board_DASH_panel,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$style,obb_demo.boardground.boardground_size(options)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$img$obb_DASH_ice,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$src,"img/ice.jpg"], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div$obb_DASH_board,(function (){var iter__6990__auto__ = (function obb_demo$boardground$render_$_iter__16448(s__16449){
return (new cljs.core.LazySeq(null,(function (){
var s__16449__$1 = s__16449;
while(true){
var temp__4657__auto__ = cljs.core.seq(s__16449__$1);
if(temp__4657__auto__){
var xs__5205__auto__ = temp__4657__auto__;
var y = cljs.core.first(xs__5205__auto__);
var iterys__6986__auto__ = ((function (s__16449__$1,y,xs__5205__auto__,temp__4657__auto__){
return (function obb_demo$boardground$render_$_iter__16448_$_iter__16450(s__16451){
return (new cljs.core.LazySeq(null,((function (s__16449__$1,y,xs__5205__auto__,temp__4657__auto__){
return (function (){
var s__16451__$1 = s__16451;
while(true){
var temp__4657__auto____$1 = cljs.core.seq(s__16451__$1);
if(temp__4657__auto____$1){
var s__16451__$2 = temp__4657__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__16451__$2)){
var c__6988__auto__ = cljs.core.chunk_first(s__16451__$2);
var size__6989__auto__ = cljs.core.count(c__6988__auto__);
var b__16453 = cljs.core.chunk_buffer(size__6989__auto__);
if((function (){var i__16452 = (0);
while(true){
if((i__16452 < size__6989__auto__)){
var x = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__6988__auto__,i__16452);
cljs.core.chunk_append(b__16453,obb_demo.boardground.square(obb_demo.boardground.prepare_game_data(game_data),x,y));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__16453),obb_demo$boardground$render_$_iter__16448_$_iter__16450(cljs.core.chunk_rest(s__16451__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__16453),null);
}
} else {
var x = cljs.core.first(s__16451__$2);
return cljs.core.cons(obb_demo.boardground.square(obb_demo.boardground.prepare_game_data(game_data),x,y),obb_demo$boardground$render_$_iter__16448_$_iter__16450(cljs.core.rest(s__16451__$2)));
}
} else {
return null;
}
...
});})(s__16449__$1,y,xs__5205__auto__,temp__4657__auto__))
,null,null));
});})(s__16449__$1,y,xs__5205__auto__,temp__4657__auto__))
;
var fs__6987__auto__ = cljs.core.seq(iterys__6986__auto__(cljs.core.range.cljs$core$IFn$_invoke$arity$2((1),(9))));
if(fs__6987__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__6987__auto__,obb_demo$boardground$render_$_iter__16448(cljs.core.rest(s__16449__$1)));
} else {
var G__16460 = cljs.core.rest(s__16449__$1);
s__16449__$1 = G__16460;
continue;
}
} else {
return null;
...
return iter__6990__auto__(cljs.core.range.cljs$core$IFn$_invoke$arity$2((1),(9)));
})()], null)], null);
});
