 ...
 */
obb_rules.translator.coordinate = (function obb_rules$translator$coordinate(focus,p__10459){
...
obb_rules.translator.convert_action = (function (){var method_table__8086__auto__ = (function (){var G__10462 = cljs.core.PersistentArrayMap.EMPTY;
return (cljs.core.atom.cljs$core$IFn$_invoke$arity$1 ? cljs.core.atom.cljs$core$IFn$_invoke$arity$1(G__10462) : cljs.core.atom.call(null,G__10462));
})();
var prefer_table__8087__auto__ = (function (){var G__10463 = cljs.core.PersistentArrayMap.EMPTY;
return (cljs.core.atom.cljs$core$IFn$_invoke$arity$1 ? cljs.core.atom.cljs$core$IFn$_invoke$arity$1(G__10463) : cljs.core.atom.call(null,G__10463));
})();
var method_cache__8088__auto__ = (function (){var G__10464 = cljs.core.PersistentArrayMap.EMPTY;
return (cljs.core.atom.cljs$core$IFn$_invoke$arity$1 ? cljs.core.atom.cljs$core$IFn$_invoke$arity$1(G__10464) : cljs.core.atom.call(null,G__10464));
})();
var cached_hierarchy__8089__auto__ = (function (){var G__10465 = cljs.core.PersistentArrayMap.EMPTY;
...
return (new cljs.core.MultiFn(cljs.core.symbol.cljs$core$IFn$_invoke$arity$2("obb-rules.translator","convert-action"),((function (method_table__8086__auto__,prefer_table__8087__auto__,method_cache__8088__auto__,cached_hierarchy__8089__auto__,hierarchy__8090__auto__){
return (function (x){
...
var translated = cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__7945__auto__ = ((function (elements){
return (function obb_rules$translator$convert_board_$_iter__10476(s__10477){
return (new cljs.core.LazySeq(null,((function (elements){
return (function (){
var s__10477__$1 = s__10477;
while(true){
var temp__4425__auto__ = cljs.core.seq(s__10477__$1);
if(temp__4425__auto__){
var s__10477__$2 = temp__4425__auto__;
if(cljs.core.chunked_seq_QMARK_(s__10477__$2)){
var c__7943__auto__ = cljs.core.chunk_first(s__10477__$2);
var size__7944__auto__ = cljs.core.count(c__7943__auto__);
var b__10479 = cljs.core.chunk_buffer(size__7944__auto__);
if((function (){var i__10478 = (0);
while(true){
if((i__10478 < size__7944__auto__)){
var vec__10484 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__7943__auto__,i__10478);
...
cljs.core.chunk_append(b__10479,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [obb_rules.translator.coordinate(cljs.core.constant$keyword$p2,k),obb_rules.translator.element(cljs.core.constant$keyword$p2,v)], null));

var G__10486 = (i__10478 + (1));
i__10478 = G__10486;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__10479),obb_rules$translator$convert_board_$_iter__10476(cljs.core.chunk_rest(s__10477__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__10479),null);
}
} else {
var vec__10485 = cljs.core.first(s__10477__$2);
...
;
return iter__7945__auto__(elements);
})());
