 ...
 */
obb_rules.translator.coordinate = (function obb_rules$translator$coordinate(focus,p__12838){
var vec__12840 = p__12838;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12840,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12840,(1),null);
...
obb_rules.translator.convert_action = (function (){var method_table__7714__auto__ = (function (){var G__12841 = cljs.core.PersistentArrayMap.EMPTY;
...
var prefer_table__7715__auto__ = (function (){var G__12842 = cljs.core.PersistentArrayMap.EMPTY;
...
var method_cache__7716__auto__ = (function (){var G__12843 = cljs.core.PersistentArrayMap.EMPTY;
...
var cached_hierarchy__7717__auto__ = (function (){var G__12844 = cljs.core.PersistentArrayMap.EMPTY;
...
return (new cljs.core.MultiFn(cljs.core.symbol.cljs$core$IFn$_invoke$arity$2("obb-rules.translator","convert-action"),((function (method_table__7714__auto__,prefer_table__7715__auto__,method_cache__7716__auto__,cached_hierarchy__7717__auto__,hierarchy__7718__auto__){
return (function (x){
...
var G__12846 = action__$1;
return (obb_rules.translator.convert_action.cljs$core$IFn$_invoke$arity$1 ? obb_rules.translator.convert_action.cljs$core$IFn$_invoke$arity$1(G__12846) : obb_rules.translator.convert_action.call(null,G__12846));
}
});
/**
...
var translated = cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__7573__auto__ = ((function (elements){
return (function obb_rules$translator$convert_board_$_iter__12857(s__12858){
return (new cljs.core.LazySeq(null,((function (elements){
return (function (){
var s__12858__$1 = s__12858;
while(true){
var temp__4425__auto__ = cljs.core.seq(s__12858__$1);
if(temp__4425__auto__){
var s__12858__$2 = temp__4425__auto__;
if(cljs.core.chunked_seq_QMARK_(s__12858__$2)){
var c__7571__auto__ = cljs.core.chunk_first(s__12858__$2);
var size__7572__auto__ = cljs.core.count(c__7571__auto__);
var b__12860 = cljs.core.chunk_buffer(size__7572__auto__);
if((function (){var i__12859 = (0);
while(true){
if((i__12859 < size__7572__auto__)){
var vec__12865 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__7571__auto__,i__12859);
...
cljs.core.chunk_append(b__12860,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [obb_rules.translator.coordinate(cljs.core.constant$keyword$p2,k),obb_rules.translator.element(cljs.core.constant$keyword$p2,v)], null));

var G__12867 = (i__12859 + (1));
i__12859 = G__12867;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__12860),obb_rules$translator$convert_board_$_iter__12857(cljs.core.chunk_rest(s__12858__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__12860),null);
}
} else {
var vec__12866 = cljs.core.first(s__12858__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12866,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12866,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [obb_rules.translator.coordinate(cljs.core.constant$keyword$p2,k),obb_rules.translator.element(cljs.core.constant$keyword$p2,v)], null),obb_rules$translator$convert_board_$_iter__12857(cljs.core.rest(s__12858__$2)));
}
} else {
return null;
}
...
;
return iter__7573__auto__(elements);
})());
