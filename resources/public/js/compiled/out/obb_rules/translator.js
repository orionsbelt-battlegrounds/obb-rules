 ...
 */
obb_rules.translator.coordinate = (function obb_rules$translator$coordinate(focus,p__12840){
var vec__12842 = p__12840;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12842,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12842,(1),null);
...
obb_rules.translator.convert_action = (function (){var method_table__7716__auto__ = (function (){var G__12843 = cljs.core.PersistentArrayMap.EMPTY;
...
var prefer_table__7717__auto__ = (function (){var G__12844 = cljs.core.PersistentArrayMap.EMPTY;
...
var method_cache__7718__auto__ = (function (){var G__12845 = cljs.core.PersistentArrayMap.EMPTY;
...
var cached_hierarchy__7719__auto__ = (function (){var G__12846 = cljs.core.PersistentArrayMap.EMPTY;
...
return (new cljs.core.MultiFn(cljs.core.symbol.cljs$core$IFn$_invoke$arity$2("obb-rules.translator","convert-action"),((function (method_table__7716__auto__,prefer_table__7717__auto__,method_cache__7718__auto__,cached_hierarchy__7719__auto__,hierarchy__7720__auto__){
return (function (x){
...
var G__12848 = action__$1;
return (obb_rules.translator.convert_action.cljs$core$IFn$_invoke$arity$1 ? obb_rules.translator.convert_action.cljs$core$IFn$_invoke$arity$1(G__12848) : obb_rules.translator.convert_action.call(null,G__12848));
}
});
/**
...
var translated = cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__7575__auto__ = ((function (elements){
return (function obb_rules$translator$convert_board_$_iter__12859(s__12860){
return (new cljs.core.LazySeq(null,((function (elements){
return (function (){
var s__12860__$1 = s__12860;
while(true){
var temp__4425__auto__ = cljs.core.seq(s__12860__$1);
if(temp__4425__auto__){
var s__12860__$2 = temp__4425__auto__;
if(cljs.core.chunked_seq_QMARK_(s__12860__$2)){
var c__7573__auto__ = cljs.core.chunk_first(s__12860__$2);
var size__7574__auto__ = cljs.core.count(c__7573__auto__);
var b__12862 = cljs.core.chunk_buffer(size__7574__auto__);
if((function (){var i__12861 = (0);
while(true){
if((i__12861 < size__7574__auto__)){
var vec__12867 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__7573__auto__,i__12861);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12867,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12867,(1),null);
cljs.core.chunk_append(b__12862,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [obb_rules.translator.coordinate(cljs.core.constant$keyword$p2,k),obb_rules.translator.element(cljs.core.constant$keyword$p2,v)], null));

var G__12869 = (i__12861 + (1));
i__12861 = G__12869;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__12862),obb_rules$translator$convert_board_$_iter__12859(cljs.core.chunk_rest(s__12860__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__12862),null);
}
} else {
var vec__12868 = cljs.core.first(s__12860__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12868,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12868,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [obb_rules.translator.coordinate(cljs.core.constant$keyword$p2,k),obb_rules.translator.element(cljs.core.constant$keyword$p2,v)], null),obb_rules$translator$convert_board_$_iter__12859(cljs.core.rest(s__12860__$2)));
}
} else {
return null;
}
...
;
return iter__7575__auto__(elements);
})());
