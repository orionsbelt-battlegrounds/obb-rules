 ...
 */
obb_rules.actions.rebound.calculate_destroyed = (function obb_rules$actions$rebound$calculate_destroyed(config,p__12631){
var map__12634 = p__12631;
...
var args = map__12634__$1;
var attacker = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12634__$1,cljs.core.constant$keyword$attacker);
var board = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12634__$1,cljs.core.constant$keyword$board);
var info = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12634__$1,cljs.core.constant$keyword$info);
var unused_damage = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12634__$1,cljs.core.constant$keyword$unused_DASH_damage);
var rebound_target = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12634__$1,cljs.core.constant$keyword$rebound_DASH_target);
var vec__12635 = obb_rules.actions.damage_calculator.destroyed_with_unused_damage.cljs$core$IFn$_invoke$arity$4(board,attacker,rebound_target,unused_damage);
var destroyed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12635,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12635,(1),null);
return destroyed;
});
/**
 * Applies rebound on the board
 */
obb_rules.actions.rebound.process_rebound = (function obb_rules$actions$rebound$process_rebound(config,p__12636){
...
var rebound_target = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12638__$1,cljs.core.constant$keyword$rebound_DASH_target);
 ...
 */
obb_rules.actions.rebound.aplicable_QMARK_ = (function obb_rules$actions$rebound$aplicable_QMARK_(config,p__12639){
...
var target = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12641__$1,cljs.core.constant$keyword$target);
var board = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12641__$1,cljs.core.constant$keyword$board);
var unused_damage = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12641__$1,cljs.core.constant$keyword$unused_DASH_damage);
var rebound_target = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12641__$1,cljs.core.constant$keyword$rebound_DASH_target);
var and__6813__auto__ = (unused_damage >= (0));
if(and__6813__auto__){
var and__6813__auto____$1 = obb_rules.actions.rebound.target_was_destroyed_QMARK_(board,target);
 ...
 */
obb_rules.actions.rebound.rebound_target = (function obb_rules$actions$rebound$rebound_target(p__12642){
...
var target = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12644__$1,cljs.core.constant$keyword$target);
...
var unused_damage = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12644__$1,cljs.core.constant$keyword$unused_DASH_damage);
 ...
 */
obb_rules.actions.rebound.process = (function obb_rules$actions$rebound$process(config,p__12645){
var map__12647 = p__12645;
