...
if(cljs.core.truth_((function (){var and__7112__auto__ = target;
 ...
 */
obb_rules.actions.triple_attack.process_triple = (function obb_rules$actions$triple_attack$process_triple(config,p__10193){
var map__10197 = p__10193;
...
var args = map__10197__$1;
var attacker = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10197__$1,cljs.core.constant$keyword$attacker);
var board = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10197__$1,cljs.core.constant$keyword$board);
var info = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10197__$1,cljs.core.constant$keyword$info);
var unused_damage = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10197__$1,cljs.core.constant$keyword$unused_DASH_damage);
var targets = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10197__$1,cljs.core.constant$keyword$triple_DASH_targets);
var targets__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(args,cljs.core.constant$keyword$triple_DASH_targets);
var vec__10199 = obb_rules.actions.triple_attack.apply_triple(config,attacker,board,info,cljs.core.first(targets__$1));
var board__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10199,(0),null);
var info__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10199,(1),null);
 ...
 */
obb_rules.actions.triple_attack.aplicable_QMARK_ = (function obb_rules$actions$triple_attack$aplicable_QMARK_(config,p__10200){
var map__10203 = p__10200;
var map__10203__$1 = ((((!((map__10203 == null)))?((((map__10203.cljs$lang$protocol_mask$partition0$ & (64))) || (map__10203.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__10203):map__10203);
var args = map__10203__$1;
var target = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10203__$1,cljs.core.constant$keyword$target);
var board = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10203__$1,cljs.core.constant$keyword$board);
var unused_damage = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10203__$1,cljs.core.constant$keyword$unused_DASH_damage);
return true;
});
/**
 * Finds the target that will be damaged by triple
 */
obb_rules.actions.triple_attack.triple_targets = (function obb_rules$actions$triple_attack$triple_targets(p__10205){
var map__10208 = p__10205;
var map__10208__$1 = ((((!((map__10208 == null)))?((((map__10208.cljs$lang$protocol_mask$partition0$ & (64))) || (map__10208.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__10208):map__10208);
var args = map__10208__$1;
var target = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10208__$1,cljs.core.constant$keyword$target);
var attacker = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10208__$1,cljs.core.constant$keyword$attacker);
var board = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10208__$1,cljs.core.constant$keyword$board);
var info = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10208__$1,cljs.core.constant$keyword$info);
 ...
 */
obb_rules.actions.triple_attack.process = (function obb_rules$actions$triple_attack$process(config,p__10210){
var map__10213 = p__10210;
...
var args = map__10213__$1;
var board = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10213__$1,cljs.core.constant$keyword$board);
var info = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10213__$1,cljs.core.constant$keyword$info);
