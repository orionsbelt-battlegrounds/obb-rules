...
if(cljs.core.truth_((function (){var and__6788__auto__ = eto;
...
var all = (function (){var iter__7554__auto__ = (function obb_rules$actions$move$tier_positions_$_iter__12777(s__12778){
return (new cljs.core.LazySeq(null,(function (){
var s__12778__$1 = s__12778;
while(true){
var temp__4425__auto__ = cljs.core.seq(s__12778__$1);
if(temp__4425__auto__){
var s__12778__$2 = temp__4425__auto__;
if(cljs.core.chunked_seq_QMARK_(s__12778__$2)){
var c__7552__auto__ = cljs.core.chunk_first(s__12778__$2);
var size__7553__auto__ = cljs.core.count(c__7552__auto__);
var b__12780 = cljs.core.chunk_buffer(size__7553__auto__);
if((function (){var i__12779 = (0);
while(true){
if((i__12779 < size__7553__auto__)){
var coord = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__7552__auto__,i__12779);
...
cljs.core.chunk_append(b__12780,cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.PersistentHashSet.EMPTY,coord_pos));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__12780),obb_rules$actions$move$tier_positions_$_iter__12777(cljs.core.chunk_rest(s__12778__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__12780),null);
}
} else {
var coord = cljs.core.first(s__12778__$2);
var element__$1 = obb_rules.element.element_coordinate.cljs$core$IFn$_invoke$arity$2(element,coord);
var coord_pos = obb_rules.actions.move.find_possible_destinations(board,element__$1);
return cljs.core.cons(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.PersistentHashSet.EMPTY,coord_pos),obb_rules$actions$move$tier_positions_$_iter__12777(cljs.core.rest(s__12778__$2)));
}
} else {
return null;
}
...
return iter__7554__auto__(cljs.core.set(coll));
})();
...
var G__12787 = board;
var G__12788 = element;
var G__12789 = mov_cost;
var G__12790 = (curr_cost + mov_cost);
var G__12791 = current_pos;
var G__12792 = all__$1;
board = G__12787;
element = G__12788;
mov_cost = G__12789;
curr_cost = G__12790;
curr_coords = G__12791;
all = G__12792;
continue;
}
break;
...
var G__12796 = board;
var G__12797 = element;
var G__12798 = mov_cost;
var G__12799 = curr_cost__$1;
var G__12800 = current_pos;
var G__12801 = all__$1;
board = G__12796;
element = G__12797;
mov_cost = G__12798;
curr_cost = G__12799;
curr_coords = G__12800;
all = G__12801;
continue;
}
break;
 ...
 */
obb_rules.actions.move.build_move = (function obb_rules$actions$move$build_move(p__12802){
var vec__12804 = p__12802;
var from = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12804,(0),null);
var to = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12804,(1),null);
var quantity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12804,(2),null);
return ((function (vec__12804,from,to,quantity){
