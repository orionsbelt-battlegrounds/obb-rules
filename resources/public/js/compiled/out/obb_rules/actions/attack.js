...
var may_try_next_QMARK_ = (function (){var or__7228__auto__ = (next_element == null);
if(or__7228__auto__){
...
var bypassed_QMARK_ = (function (){var or__7228__auto__ = bypassed_element_QMARK_;
...
var G__10353 = board;
var G__10354 = attacker;
var G__10355 = target;
var G__10356 = next_coordinate;
var G__10357 = ((1) + distance);
var G__10358 = bypassed_QMARK_;
board = G__10353;
attacker = G__10354;
target = G__10355;
current_coordinate = G__10356;
distance = G__10357;
bypassed_element_QMARK_ = G__10358;
continue;
} else {
return cljs.core.cst$kw$out_DASH_of_DASH_range;
...
var G__10361 = cljs.core.cst$kw$after_DASH_attack;
var G__10362 = new cljs.core.PersistentArrayMap(null, 5, [cljs.core.cst$kw$board,board,cljs.core.cst$kw$attacker,attacker,cljs.core.cst$kw$target,target,cljs.core.cst$kw$unused_DASH_damage,unused_damage,cljs.core.cst$kw$info,info], null);
return (obb_rules.actions.hooks.process.cljs$core$IFn$_invoke$arity$2 ? obb_rules.actions.hooks.process.cljs$core$IFn$_invoke$arity$2(G__10361,G__10362) : obb_rules.actions.hooks.process.call(null,G__10361,G__10362));
});
/**
...
var G__10365 = cljs.core.cst$kw$after_DASH_hit;
var G__10366 = new cljs.core.PersistentArrayMap(null, 5, [cljs.core.cst$kw$board,board,cljs.core.cst$kw$attacker,attacker,cljs.core.cst$kw$target,target,cljs.core.cst$kw$unused_DASH_damage,unused_damage,cljs.core.cst$kw$info,info], null);
return (obb_rules.actions.hooks.process.cljs$core$IFn$_invoke$arity$2 ? obb_rules.actions.hooks.process.cljs$core$IFn$_invoke$arity$2(G__10365,G__10366) : obb_rules.actions.hooks.process.call(null,G__10365,G__10366));
});
/**
...
var vec__10368 = obb_rules.actions.attack.process_after_attack(board,attacker,target,unused_damage,info);
var board__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10368,(0),null);
var info__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10368,(1),null);
...
var vec__10371 = obb_rules.actions.damage_calculator.destroyed_with_unused_damage.cljs$core$IFn$_invoke$arity$3(board,attacker,target);
var destroyed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10371,(0),null);
var unused_damage = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10371,(1),null);
...
var vec__10372 = obb_rules.actions.attack.process_hooks(attacked_board,attacker,target,unused_damage,attack_info);
var final_board = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10372,(0),null);
var final_info = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10372,(1),null);
 ...
 */
obb_rules.actions.attack.build_attack = (function obb_rules$actions$attack$build_attack(p__10373){
var vec__10377 = p__10373;
var coord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10377,(0),null);
var target_coord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10377,(1),null);
return ((function (vec__10377,coord,target_coord){
...
var vec__10379 = obb_rules.actions.attack.resolve_attack(board,player,attacker__$1,target);
var success_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10379,(0),null);
var info = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10379,(1),null);
