...
var G__23175 = board;
var G__23176 = attacker;
var G__23177 = target;
var G__23178 = next_coordinate;
var G__23179 = ((1) + distance);
var G__23180 = bypassed_QMARK_;
board = G__23175;
attacker = G__23176;
target = G__23177;
current_coordinate = G__23178;
distance = G__23179;
bypassed_element_QMARK_ = G__23180;
continue;
} else {
return new cljs.core.Keyword(null,"out-of-range","out-of-range",692318589);
...
var vec__23182 = obb_rules.actions.attack.process_after_attack.call(null,board,attacker,target,unused_damage,info);
var board__$1 = cljs.core.nth.call(null,vec__23182,(0),null);
var info__$1 = cljs.core.nth.call(null,vec__23182,(1),null);
...
var vec__23185 = obb_rules.actions.damage_calculator.destroyed_with_unused_damage.call(null,board,attacker,target);
var destroyed = cljs.core.nth.call(null,vec__23185,(0),null);
var unused_damage = cljs.core.nth.call(null,vec__23185,(1),null);
...
var vec__23186 = obb_rules.actions.attack.process_hooks.call(null,attacked_board,attacker,target,unused_damage,attack_info);
var final_board = cljs.core.nth.call(null,vec__23186,(0),null);
var final_info = cljs.core.nth.call(null,vec__23186,(1),null);
return obb_rules.result.action_success.call(null,final_board,(1),"OK",final_info);
});
/**
 * Builds an attack action on a board
 */
obb_rules.actions.attack.build_attack = (function obb_rules$actions$attack$build_attack(p__23187){
var vec__23191 = p__23187;
var coord = cljs.core.nth.call(null,vec__23191,(0),null);
var target_coord = cljs.core.nth.call(null,vec__23191,(1),null);
return ((function (vec__23191,coord,target_coord){
...
var vec__23193 = obb_rules.actions.attack.resolve_attack.call(null,board,player,attacker__$1,target);
var success_QMARK_ = cljs.core.nth.call(null,vec__23193,(0),null);
var info = cljs.core.nth.call(null,vec__23193,(1),null);
...
;})(vec__23191,coord,target_coord))
});

//# sourceMappingURL=attack.js.map?rel=1436104824375