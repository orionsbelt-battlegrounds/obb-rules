...
var may_try_next_QMARK_ = (function (){var or__6210__auto__ = (next_element == null);
if(or__6210__auto__){
...
var bypassed_QMARK_ = (function (){var or__6210__auto__ = bypassed_element_QMARK_;
...
var G__15459 = board;
var G__15460 = attacker;
var G__15461 = target;
var G__15462 = next_coordinate;
var G__15463 = ((1) + distance);
var G__15464 = bypassed_QMARK_;
board = G__15459;
attacker = G__15460;
target = G__15461;
current_coordinate = G__15462;
distance = G__15463;
bypassed_element_QMARK_ = G__15464;
continue;
} else {
return cljs.core.cst$kw$out_DASH_of_DASH_range;
...
var G__15467 = cljs.core.cst$kw$after_DASH_attack;
var G__15468 = new cljs.core.PersistentArrayMap(null, 5, [cljs.core.cst$kw$board,board,cljs.core.cst$kw$attacker,attacker,cljs.core.cst$kw$target,target,cljs.core.cst$kw$unused_DASH_damage,unused_damage,cljs.core.cst$kw$info,info], null);
return (obb_rules.actions.hooks.process.cljs$core$IFn$_invoke$arity$2 ? obb_rules.actions.hooks.process.cljs$core$IFn$_invoke$arity$2(G__15467,G__15468) : obb_rules.actions.hooks.process.call(null,G__15467,G__15468));
});
/**
...
var G__15471 = cljs.core.cst$kw$after_DASH_hit;
var G__15472 = new cljs.core.PersistentArrayMap(null, 5, [cljs.core.cst$kw$board,board,cljs.core.cst$kw$attacker,attacker,cljs.core.cst$kw$target,target,cljs.core.cst$kw$unused_DASH_damage,unused_damage,cljs.core.cst$kw$info,info], null);
return (obb_rules.actions.hooks.process.cljs$core$IFn$_invoke$arity$2 ? obb_rules.actions.hooks.process.cljs$core$IFn$_invoke$arity$2(G__15471,G__15472) : obb_rules.actions.hooks.process.call(null,G__15471,G__15472));
});
/**
...
var vec__15474 = obb_rules.actions.attack.process_after_attack(board,attacker,target,unused_damage,info);
var board__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15474,(0),null);
var info__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15474,(1),null);
...
var vec__15477 = obb_rules.actions.damage_calculator.destroyed_with_unused_damage.cljs$core$IFn$_invoke$arity$3(board,attacker,target);
var destroyed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15477,(0),null);
var unused_damage = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15477,(1),null);
...
var vec__15478 = obb_rules.actions.attack.process_hooks(attacked_board,attacker,target,unused_damage,attack_info);
var final_board = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15478,(0),null);
var final_info = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15478,(1),null);
 ...
 */
obb_rules.actions.attack.build_attack = (function obb_rules$actions$attack$build_attack(p__15479){
var vec__15483 = p__15479;
var coord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15483,(0),null);
var target_coord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15483,(1),null);
return ((function (vec__15483,coord,target_coord){
...
var vec__15485 = obb_rules.actions.attack.resolve_attack(board,player,attacker__$1,target);
var success_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15485,(0),null);
var info = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15485,(1),null);
