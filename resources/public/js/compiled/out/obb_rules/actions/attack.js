...
var may_try_next_QMARK_ = (function (){var or__7199__auto__ = (next_element == null);
if(or__7199__auto__){
...
var bypassed_QMARK_ = (function (){var or__7199__auto__ = bypassed_element_QMARK_;
...
var G__10324 = board;
var G__10325 = attacker;
var G__10326 = target;
var G__10327 = next_coordinate;
var G__10328 = ((1) + distance);
var G__10329 = bypassed_QMARK_;
board = G__10324;
attacker = G__10325;
target = G__10326;
current_coordinate = G__10327;
distance = G__10328;
bypassed_element_QMARK_ = G__10329;
continue;
} else {
return cljs.core.constant$keyword$out_DASH_of_DASH_range;
...
var G__10332 = cljs.core.constant$keyword$after_DASH_attack;
var G__10333 = new cljs.core.PersistentArrayMap(null, 5, [cljs.core.constant$keyword$board,board,cljs.core.constant$keyword$attacker,attacker,cljs.core.constant$keyword$target,target,cljs.core.constant$keyword$unused_DASH_damage,unused_damage,cljs.core.constant$keyword$info,info], null);
return (obb_rules.actions.hooks.process.cljs$core$IFn$_invoke$arity$2 ? obb_rules.actions.hooks.process.cljs$core$IFn$_invoke$arity$2(G__10332,G__10333) : obb_rules.actions.hooks.process.call(null,G__10332,G__10333));
});
/**
...
var G__10336 = cljs.core.constant$keyword$after_DASH_hit;
var G__10337 = new cljs.core.PersistentArrayMap(null, 5, [cljs.core.constant$keyword$board,board,cljs.core.constant$keyword$attacker,attacker,cljs.core.constant$keyword$target,target,cljs.core.constant$keyword$unused_DASH_damage,unused_damage,cljs.core.constant$keyword$info,info], null);
return (obb_rules.actions.hooks.process.cljs$core$IFn$_invoke$arity$2 ? obb_rules.actions.hooks.process.cljs$core$IFn$_invoke$arity$2(G__10336,G__10337) : obb_rules.actions.hooks.process.call(null,G__10336,G__10337));
});
/**
...
var vec__10339 = obb_rules.actions.attack.process_after_attack(board,attacker,target,unused_damage,info);
var board__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10339,(0),null);
var info__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10339,(1),null);
...
var vec__10342 = obb_rules.actions.damage_calculator.destroyed_with_unused_damage.cljs$core$IFn$_invoke$arity$3(board,attacker,target);
var destroyed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10342,(0),null);
var unused_damage = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10342,(1),null);
...
var vec__10343 = obb_rules.actions.attack.process_hooks(attacked_board,attacker,target,unused_damage,attack_info);
var final_board = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10343,(0),null);
var final_info = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10343,(1),null);
 ...
 */
obb_rules.actions.attack.build_attack = (function obb_rules$actions$attack$build_attack(p__10344){
var vec__10348 = p__10344;
var coord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10348,(0),null);
var target_coord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10348,(1),null);
return ((function (vec__10348,coord,target_coord){
...
var vec__10350 = obb_rules.actions.attack.resolve_attack(board,player,attacker__$1,target);
var success_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10350,(0),null);
var info = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10350,(1),null);
