...
var current_state = (function (){var G__12797 = cljs.core.constant$keyword$state;
return (game.cljs$core$IFn$_invoke$arity$1 ? game.cljs$core$IFn$_invoke$arity$1(G__12797) : game.call(null,G__12797));
})();
var or__6936__auto__ = (current_state == null);
if(or__6936__auto__){
...
var or__6936__auto__ = (function (){var G__12801 = cljs.core.constant$keyword$mode;
return (game.cljs$core$IFn$_invoke$arity$1 ? game.cljs$core$IFn$_invoke$arity$1(G__12801) : game.call(null,G__12801));
})();
...
var G__12804 = cljs.core.constant$keyword$state;
return (game.cljs$core$IFn$_invoke$arity$1 ? game.cljs$core$IFn$_invoke$arity$1(G__12804) : game.call(null,G__12804));
});
...
var G__12807 = cljs.core.constant$keyword$action_DASH_results;
return (game.cljs$core$IFn$_invoke$arity$1 ? game.cljs$core$IFn$_invoke$arity$1(G__12807) : game.call(null,G__12807));
});
/**
 * Stores an action's result
 */
obb_rules.game.push_result = (function obb_rules$game$push_result(game,raw_action,result){
var action_results = (function (){var or__6936__auto__ = obb_rules.game.action_results(game);
if(cljs.core.truth_(or__6936__auto__)){
return or__6936__auto__;
} else {
...
return cljs.core.every_QMARK_((function (p1__12808_SHARP_){
return obb_rules.result.succeeded_QMARK_(cljs.core.last(p1__12808_SHARP_));
