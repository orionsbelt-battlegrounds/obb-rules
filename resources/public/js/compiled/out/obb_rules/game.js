...
var current_state = (function (){var G__12799 = cljs.core.constant$keyword$state;
return (game.cljs$core$IFn$_invoke$arity$1 ? game.cljs$core$IFn$_invoke$arity$1(G__12799) : game.call(null,G__12799));
})();
var or__6938__auto__ = (current_state == null);
if(or__6938__auto__){
...
var or__6938__auto__ = (function (){var G__12803 = cljs.core.constant$keyword$mode;
return (game.cljs$core$IFn$_invoke$arity$1 ? game.cljs$core$IFn$_invoke$arity$1(G__12803) : game.call(null,G__12803));
})();
...
var G__12806 = cljs.core.constant$keyword$state;
return (game.cljs$core$IFn$_invoke$arity$1 ? game.cljs$core$IFn$_invoke$arity$1(G__12806) : game.call(null,G__12806));
});
...
var G__12809 = cljs.core.constant$keyword$action_DASH_results;
return (game.cljs$core$IFn$_invoke$arity$1 ? game.cljs$core$IFn$_invoke$arity$1(G__12809) : game.call(null,G__12809));
});
/**
 * Stores an action's result
 */
obb_rules.game.push_result = (function obb_rules$game$push_result(game,raw_action,result){
var action_results = (function (){var or__6938__auto__ = obb_rules.game.action_results(game);
if(cljs.core.truth_(or__6938__auto__)){
return or__6938__auto__;
} else {
...
return cljs.core.every_QMARK_((function (p1__12810_SHARP_){
return obb_rules.result.succeeded_QMARK_(cljs.core.last(p1__12810_SHARP_));
