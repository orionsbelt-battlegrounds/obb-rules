...
var current_state = (function (){var G__12686 = cljs.core.constant$keyword$state;
return (game.cljs$core$IFn$_invoke$arity$1 ? game.cljs$core$IFn$_invoke$arity$1(G__12686) : game.call(null,G__12686));
})();
var or__6825__auto__ = (current_state == null);
if(or__6825__auto__){
...
var or__6825__auto__ = (function (){var G__12690 = cljs.core.constant$keyword$mode;
...
var G__12693 = cljs.core.constant$keyword$state;
return (game.cljs$core$IFn$_invoke$arity$1 ? game.cljs$core$IFn$_invoke$arity$1(G__12693) : game.call(null,G__12693));
});
...
var G__12696 = cljs.core.constant$keyword$action_DASH_results;
return (game.cljs$core$IFn$_invoke$arity$1 ? game.cljs$core$IFn$_invoke$arity$1(G__12696) : game.call(null,G__12696));
});
/**
 * Stores an action's result
 */
obb_rules.game.push_result = (function obb_rules$game$push_result(game,raw_action,result){
var action_results = (function (){var or__6825__auto__ = obb_rules.game.action_results(game);
if(cljs.core.truth_(or__6825__auto__)){
return or__6825__auto__;
} else {
...
return cljs.core.every_QMARK_((function (p1__12697_SHARP_){
return obb_rules.result.succeeded_QMARK_(cljs.core.last(p1__12697_SHARP_));
