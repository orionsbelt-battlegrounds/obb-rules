...
var G__12453 = cljs.core.constant$keyword$player;
return (element.cljs$core$IFn$_invoke$arity$1 ? element.cljs$core$IFn$_invoke$arity$1(G__12453) : element.call(null,G__12453));
});
/**
 * Element's unit
 */
obb_rules.element.element_unit = (function obb_rules$element$element_unit(element){
var G__12455 = cljs.core.constant$keyword$unit;
return (element.cljs$core$IFn$_invoke$arity$1 ? element.cljs$core$IFn$_invoke$arity$1(G__12455) : element.call(null,G__12455));
});
/**
...
var G__12458 = cljs.core.constant$keyword$direction;
return (element.cljs$core$IFn$_invoke$arity$1 ? element.cljs$core$IFn$_invoke$arity$1(G__12458) : element.call(null,G__12458));
});
...
var G__12462 = cljs.core.constant$keyword$hitpoints;
return (element.cljs$core$IFn$_invoke$arity$1 ? element.cljs$core$IFn$_invoke$arity$1(G__12462) : element.call(null,G__12462));
});
...
var or__6800__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(specific,specific_type);
...
var G__12466 = cljs.core.constant$keyword$quantity;
return (element.cljs$core$IFn$_invoke$arity$1 ? element.cljs$core$IFn$_invoke$arity$1(G__12466) : element.call(null,G__12466));
});
...
var c = (function (){var G__12470 = cljs.core.constant$keyword$coordinate;
return (element.cljs$core$IFn$_invoke$arity$1 ? element.cljs$core$IFn$_invoke$arity$1(G__12470) : element.call(null,G__12470));
})();
...
return (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(obb_rules.element.element_player(e1),obb_rules.element.element_player(e2))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(obb_rules.element.element_unit(e1),obb_rules.element.element_unit(e2)));
});
/**
...
return obb_rules.element.join_elements.cljs$core$IFn$_invoke$arity$variadic(argseq__7840__auto__);
});
...
obb_rules.element.join_elements.cljs$lang$applyTo = (function (seq12472){
return obb_rules.element.join_elements.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq12472));
});
/**
 * True if the element is frozen
 */
obb_rules.element.frozen_QMARK_ = (function obb_rules$element$frozen_QMARK_(element){
var and__6788__auto__ = element;
if(cljs.core.truth_(and__6788__auto__)){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(true,(function (){var G__12474 = cljs.core.constant$keyword$frozen;
return (element.cljs$core$IFn$_invoke$arity$1 ? element.cljs$core$IFn$_invoke$arity$1(G__12474) : element.call(null,G__12474));
})());
} else {
...
if(cljs.core.truth_(obb_rules.element.element_player(element))){
} else {
