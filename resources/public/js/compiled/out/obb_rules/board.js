 ...
 */
obb_rules.board.player_element_QMARK_ = (function obb_rules$board$player_element_QMARK_(player,p__12496){
var vec__12498 = p__12496;
var coordinate = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12498,(0),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12498,(1),null);
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12499_SHARP_){
return cljs.core.last(p1__12499_SHARP_);
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(obb_rules.board.player_element_QMARK_,player),(function (){var G__12501 = cljs.core.constant$keyword$elements;
return (board.cljs$core$IFn$_invoke$arity$1 ? board.cljs$core$IFn$_invoke$arity$1(G__12501) : board.call(null,G__12501));
})()));
});
/**
...
return cljs.core.count((function (){var G__12504 = cljs.core.constant$keyword$elements;
return (board.cljs$core$IFn$_invoke$arity$1 ? board.cljs$core$IFn$_invoke$arity$1(G__12504) : board.call(null,G__12504));
})());
});
...
var or__6800__auto__ = (function (){var G__12512 = cljs.core.constant$keyword$width;
return (board.cljs$core$IFn$_invoke$arity$1 ? board.cljs$core$IFn$_invoke$arity$1(G__12512) : board.call(null,G__12512));
})();
...
var or__6800__auto__ = (function (){var G__12516 = cljs.core.constant$keyword$height;
return (board.cljs$core$IFn$_invoke$arity$1 ? board.cljs$core$IFn$_invoke$arity$1(G__12516) : board.call(null,G__12516));
})();
if(cljs.core.truth_(or__6800__auto__)){
return or__6800__auto__;
} else {
...
var G__12518 = cljs.core.constant$keyword$terrain;
return (board.cljs$core$IFn$_invoke$arity$1 ? board.cljs$core$IFn$_invoke$arity$1(G__12518) : board.call(null,G__12518));
});
/**
...
var G__12521 = cljs.core.constant$keyword$elements;
return (board.cljs$core$IFn$_invoke$arity$1 ? board.cljs$core$IFn$_invoke$arity$1(G__12521) : board.call(null,G__12521));
});
...
var or__6800__auto__ = obb_rules.board.get_element(board,coord);
if(cljs.core.truth_(or__6800__auto__)){
return or__6800__auto__;
} else {
 ...
 */
obb_rules.board.in_bounds_QMARK_ = (function obb_rules$board$in_bounds_QMARK_(board,p__12523){
var vec__12525 = p__12523;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12525,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12525,(1),null);
...
var and__6788__auto__ = obb_rules.board.in_bounds_QMARK_(board,coord);
...
var all_removed = (function (){var or__6800__auto__ = (function (){var G__12529 = cljs.core.constant$keyword$removed_DASH_elements;
return (board.cljs$core$IFn$_invoke$arity$1 ? board.cljs$core$IFn$_invoke$arity$1(G__12529) : board.call(null,G__12529));
})();
if(cljs.core.truth_(or__6800__auto__)){
return or__6800__auto__;
} else {
...
var elements = (function (){var G__12532 = cljs.core.constant$keyword$elements;
return (board.cljs$core$IFn$_invoke$arity$1 ? board.cljs$core$IFn$_invoke$arity$1(G__12532) : board.call(null,G__12532));
})();
...
var elements = (function (){var G__12535 = cljs.core.constant$keyword$elements;
return (board.cljs$core$IFn$_invoke$arity$1 ? board.cljs$core$IFn$_invoke$arity$1(G__12535) : board.call(null,G__12535));
})();
 ...
 */
obb_rules.board.adjacent_QMARK_ = (function obb_rules$board$adjacent_QMARK_(p__12536,p__12537){
var vec__12540 = p__12536;
var c1x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12540,(0),null);
var c1y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12540,(1),null);
var vec__12541 = p__12537;
var c2x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12541,(0),null);
var c2y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12541,(1),null);
...
var element = (function (){var or__6800__auto__ = obb_rules.board.get_element(board,coord);
if(cljs.core.truth_(or__6800__auto__)){
return or__6800__auto__;
} else {
return from_element;
...
var quantity = (function (){var or__6800__auto__ = (0);
if(cljs.core.truth_(or__6800__auto__)){
return or__6800__auto__;
} else {
