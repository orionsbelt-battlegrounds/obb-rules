...
obb_rules.unit.CombatUnit.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__16706__auto__,k22981,else__16707__auto__){
var self__ = this;
var this__16706__auto____$1 = this;
var G__22983 = (((k22981 instanceof cljs.core.Keyword))?k22981.fqn:null);
switch (G__22983) {
case "category":
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k22981,else__16707__auto__);
...
obb_rules.unit.CombatUnit.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__16711__auto__,k__16712__auto__,G__22980){
var self__ = this;
var this__16711__auto____$1 = this;
var pred__22984 = cljs.core.keyword_identical_QMARK_;
var expr__22985 = k__16712__auto__;
if(cljs.core.truth_(pred__22984.call(null,new cljs.core.Keyword(null,"name","name",1843675177),expr__22985))){
return (new obb_rules.unit.CombatUnit(G__22980,self__.code,self__.value,self__.attack,self__.attack_type,self__.range,self__.defense,self__.bonus,self__.type,self__.category,self__.displacement,self__.movement_type,self__.movement_cost,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__22984.call(null,new cljs.core.Keyword(null,"code","code",1586293142),expr__22985))){
return (new obb_rules.unit.CombatUnit(self__.name,G__22980,self__.value,self__.attack,self__.attack_type,self__.range,self__.defense,self__.bonus,self__.type,self__.category,self__.displacement,self__.movement_type,self__.movement_cost,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__22984.call(null,new cljs.core.Keyword(null,"value","value",305978217),expr__22985))){
return (new obb_rules.unit.CombatUnit(self__.name,self__.code,G__22980,self__.attack,self__.attack_type,self__.range,self__.defense,self__.bonus,self__.type,self__.category,self__.displacement,self__.movement_type,self__.movement_cost,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__22984.call(null,new cljs.core.Keyword(null,"attack","attack",1957061788),expr__22985))){
return (new obb_rules.unit.CombatUnit(self__.name,self__.code,self__.value,G__22980,self__.attack_type,self__.range,self__.defense,self__.bonus,self__.type,self__.category,self__.displacement,self__.movement_type,self__.movement_cost,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__22984.call(null,new cljs.core.Keyword(null,"attack-type","attack-type",-639911421),expr__22985))){
return (new obb_rules.unit.CombatUnit(self__.name,self__.code,self__.value,self__.attack,G__22980,self__.range,self__.defense,self__.bonus,self__.type,self__.category,self__.displacement,self__.movement_type,self__.movement_cost,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__22984.call(null,new cljs.core.Keyword(null,"range","range",1639692286),expr__22985))){
return (new obb_rules.unit.CombatUnit(self__.name,self__.code,self__.value,self__.attack,self__.attack_type,G__22980,self__.defense,self__.bonus,self__.type,self__.category,self__.displacement,self__.movement_type,self__.movement_cost,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__22984.call(null,new cljs.core.Keyword(null,"defense","defense",1755014992),expr__22985))){
return (new obb_rules.unit.CombatUnit(self__.name,self__.code,self__.value,self__.attack,self__.attack_type,self__.range,G__22980,self__.bonus,self__.type,self__.category,self__.displacement,self__.movement_type,self__.movement_cost,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__22984.call(null,new cljs.core.Keyword(null,"bonus","bonus",-1684391149),expr__22985))){
return (new obb_rules.unit.CombatUnit(self__.name,self__.code,self__.value,self__.attack,self__.attack_type,self__.range,self__.defense,G__22980,self__.type,self__.category,self__.displacement,self__.movement_type,self__.movement_cost,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__22984.call(null,new cljs.core.Keyword(null,"type","type",1174270348),expr__22985))){
return (new obb_rules.unit.CombatUnit(self__.name,self__.code,self__.value,self__.attack,self__.attack_type,self__.range,self__.defense,self__.bonus,G__22980,self__.category,self__.displacement,self__.movement_type,self__.movement_cost,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__22984.call(null,new cljs.core.Keyword(null,"category","category",-593092832),expr__22985))){
return (new obb_rules.unit.CombatUnit(self__.name,self__.code,self__.value,self__.attack,self__.attack_type,self__.range,self__.defense,self__.bonus,self__.type,G__22980,self__.displacement,self__.movement_type,self__.movement_cost,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__22984.call(null,new cljs.core.Keyword(null,"displacement","displacement",-1309600669),expr__22985))){
return (new obb_rules.unit.CombatUnit(self__.name,self__.code,self__.value,self__.attack,self__.attack_type,self__.range,self__.defense,self__.bonus,self__.type,self__.category,G__22980,self__.movement_type,self__.movement_cost,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__22984.call(null,new cljs.core.Keyword(null,"movement-type","movement-type",-1340819145),expr__22985))){
return (new obb_rules.unit.CombatUnit(self__.name,self__.code,self__.value,self__.attack,self__.attack_type,self__.range,self__.defense,self__.bonus,self__.type,self__.category,self__.displacement,G__22980,self__.movement_cost,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__22984.call(null,new cljs.core.Keyword(null,"movement-cost","movement-cost",-716301045),expr__22985))){
return (new obb_rules.unit.CombatUnit(self__.name,self__.code,self__.value,self__.attack,self__.attack_type,self__.range,self__.defense,self__.bonus,self__.type,self__.category,self__.displacement,self__.movement_type,G__22980,self__.__meta,self__.__extmap,null));
} else {
...
obb_rules.unit.CombatUnit.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__16703__auto__,G__22980){
var self__ = this;
var this__16703__auto____$1 = this;
return (new obb_rules.unit.CombatUnit(self__.name,self__.code,self__.value,self__.attack,self__.attack_type,self__.range,self__.defense,self__.bonus,self__.type,self__.category,self__.displacement,self__.movement_type,self__.movement_cost,G__22980,self__.__extmap,self__.__hash));
});
 ...
 * Represents a combat unit
 */
obb_rules.unit.map__GT_CombatUnit = (function obb_rules$unit$map__GT_CombatUnit(G__22982){
return (new obb_rules.unit.CombatUnit(new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(G__22982),new cljs.core.Keyword(null,"code","code",1586293142).cljs$core$IFn$_invoke$arity$1(G__22982),new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(G__22982),new cljs.core.Keyword(null,"attack","attack",1957061788).cljs$core$IFn$_invoke$arity$1(G__22982),new cljs.core.Keyword(null,"attack-type","attack-type",-639911421).cljs$core$IFn$_invoke$arity$1(G__22982),new cljs.core.Keyword(null,"range","range",1639692286).cljs$core$IFn$_invoke$arity$1(G__22982),new cljs.core.Keyword(null,"defense","defense",1755014992).cljs$core$IFn$_invoke$arity$1(G__22982),new cljs.core.Keyword(null,"bonus","bonus",-1684391149).cljs$core$IFn$_invoke$arity$1(G__22982),new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(G__22982),new cljs.core.Keyword(null,"category","category",-593092832).cljs$core$IFn$_invoke$arity$1(G__22982),new cljs.core.Keyword(null,"displacement","displacement",-1309600669).cljs$core$IFn$_invoke$arity$1(G__22982),new cljs.core.Keyword(null,"movement-type","movement-type",-1340819145).cljs$core$IFn$_invoke$arity$1(G__22982),new cljs.core.Keyword(null,"movement-cost","movement-cost",-716301045).cljs$core$IFn$_invoke$arity$1(G__22982),null,cljs.core.dissoc.call(null,G__22982,new cljs.core.Keyword(null,"name","name",1843675177),new cljs.core.Keyword(null,"code","code",1586293142),new cljs.core.Keyword(null,"value","value",305978217),new cljs.core.Keyword(null,"attack","attack",1957061788),new cljs.core.Keyword(null,"attack-type","attack-type",-639911421),new cljs.core.Keyword(null,"range","range",1639692286),new cljs.core.Keyword(null,"defense","defense",1755014992),new cljs.core.Keyword(null,"bonus","bonus",-1684391149),new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"category","category",-593092832),new cljs.core.Keyword(null,"displacement","displacement",-1309600669),new cljs.core.Keyword(null,"movement-type","movement-type",-1340819145),new cljs.core.Keyword(null,"movement-cost","movement-cost",-716301045)),null));
});
...
return cljs.core.mapv.call(null,(function (p1__22988_SHARP_){
return obb_rules.unit.map__GT_CombatUnit.call(null,p1__22988_SHARP_);
...
return cljs.core.reduce.call(null,(function (p1__22989_SHARP_,p2__22990_SHARP_){
return cljs.core.conj.call(null,p1__22989_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [selector.call(null,p2__22990_SHARP_),p2__22990_SHARP_], null));
...
//# sourceMappingURL=unit.js.map?rel=1436104823559