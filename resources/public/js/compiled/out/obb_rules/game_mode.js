...
var and__6924__auto__ = obb_rules.stash.cleared_QMARK_(stash1);
...
var and__6924__auto__ = !(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(obb_rules.game.state.cljs$core$IFn$_invoke$arity$1(game)),cljs.core.constant$keyword$deploy));
if(and__6924__auto__){
var or__6936__auto__ = obb_rules.board.empty_board_QMARK_.cljs$core$IFn$_invoke$arity$2(game,cljs.core.constant$keyword$p1);
...
return cljs.core.some(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [cljs.core.constant$keyword$p2,null,cljs.core.constant$keyword$p1,null], null), null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1((function (){var G__13087 = cljs.core.constant$keyword$state;
return (game.cljs$core$IFn$_invoke$arity$1 ? game.cljs$core$IFn$_invoke$arity$1(G__13087) : game.call(null,G__13087));
})())], null));
});
/**
...
var current_player = cljs.core.keyword.cljs$core$IFn$_invoke$arity$1((function (){var G__13089 = cljs.core.constant$keyword$state;
return (game.cljs$core$IFn$_invoke$arity$1 ? game.cljs$core$IFn$_invoke$arity$1(G__13089) : game.call(null,G__13089));
})());
