 ...
 */
obb_rules.auto_deploys.common.map_stash_to_units = (function obb_rules$auto_deploys$common$map_stash_to_units(p__15654){
var vec__15656 = p__15654;
var unit_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15656,(0),null);
var quantity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15656,(1),null);
...
return cljs.core.take.cljs$core$IFn$_invoke$arity$2(units,cljs.core.repeat.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(p1__15657_SHARP_)], null)));
});})(squares,units))
,stash);
 ...
 */
obb_rules.auto_deploys.common.split_stash = (function obb_rules$auto_deploys$common$split_stash(lineup,p__15659){
var vec__15661 = p__15659;
var unit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15661,(0),null);
var quantity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15661,(1),null);
var slots = cljs.core.count(cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (vec__15661,unit,quantity){
return (function (p1__15658_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(unit,p1__15658_SHARP_);
});})(vec__15661,unit,quantity))
,lineup));
 ...
 */
obb_rules.auto_deploys.common.build_deploy_action = (function obb_rules$auto_deploys$common$build_deploy_action(player,row,idx,p__15662){
var vec__15664 = p__15662;
var u = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15664,(0),null);
var q = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15664,(1),null);
...
var G__15667 = obb_rules.result.result_board(result);
var G__15668 = player;
return (action.cljs$core$IFn$_invoke$arity$2 ? action.cljs$core$IFn$_invoke$arity$2(G__15667,G__15668) : action.call(null,G__15667,G__15668));
}
});
