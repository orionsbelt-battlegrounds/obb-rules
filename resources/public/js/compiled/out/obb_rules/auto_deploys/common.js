 ...
 */
obb_rules.auto_deploys.common.map_stash_to_units = (function obb_rules$auto_deploys$common$map_stash_to_units(p__10525){
var vec__10527 = p__10525;
var unit_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10527,(0),null);
var quantity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10527,(1),null);
...
return cljs.core.take.cljs$core$IFn$_invoke$arity$2(units,cljs.core.repeat.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(p1__10528_SHARP_)], null)));
});})(squares,units))
,stash);
 ...
 */
obb_rules.auto_deploys.common.split_stash = (function obb_rules$auto_deploys$common$split_stash(lineup,p__10530){
var vec__10532 = p__10530;
var unit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10532,(0),null);
var quantity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10532,(1),null);
var slots = cljs.core.count(cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (vec__10532,unit,quantity){
return (function (p1__10529_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(unit,p1__10529_SHARP_);
});})(vec__10532,unit,quantity))
,lineup));
 ...
 */
obb_rules.auto_deploys.common.build_deploy_action = (function obb_rules$auto_deploys$common$build_deploy_action(player,row,idx,p__10533){
var vec__10535 = p__10533;
var u = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10535,(0),null);
var q = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10535,(1),null);
...
var G__10538 = obb_rules.result.result_board(result);
var G__10539 = player;
return (action.cljs$core$IFn$_invoke$arity$2 ? action.cljs$core$IFn$_invoke$arity$2(G__10538,G__10539) : action.call(null,G__10538,G__10539));
}
});
