 ...
 */
obb_rules.auto_deploys.common.map_stash_to_units = (function obb_rules$auto_deploys$common$map_stash_to_units(p__15263){
var vec__15265 = p__15263;
var unit_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15265,(0),null);
var quantity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15265,(1),null);
...
return cljs.core.take.cljs$core$IFn$_invoke$arity$2(units,cljs.core.repeat.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(p1__15266_SHARP_)], null)));
});})(squares,units))
,stash);
 ...
 */
obb_rules.auto_deploys.common.split_stash = (function obb_rules$auto_deploys$common$split_stash(lineup,p__15268){
var vec__15270 = p__15268;
var unit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15270,(0),null);
var quantity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15270,(1),null);
var slots = cljs.core.count(cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (vec__15270,unit,quantity){
return (function (p1__15267_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(unit,p1__15267_SHARP_);
});})(vec__15270,unit,quantity))
,lineup));
 ...
 */
obb_rules.auto_deploys.common.build_deploy_action = (function obb_rules$auto_deploys$common$build_deploy_action(player,row,idx,p__15271){
var vec__15273 = p__15271;
var u = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15273,(0),null);
var q = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15273,(1),null);
...
var G__15276 = obb_rules.result.result_board(result);
var G__15277 = player;
return (action.cljs$core$IFn$_invoke$arity$2 ? action.cljs$core$IFn$_invoke$arity$2(G__15276,G__15277) : action.call(null,G__15276,G__15277));
}
});
