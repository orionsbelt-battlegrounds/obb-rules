 ...
 */
obb_rules.auto_deploys.common.map_stash_to_units = (function obb_rules$auto_deploys$common$map_stash_to_units(p__12232){
var vec__12234 = p__12232;
var unit_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12234,(0),null);
var quantity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12234,(1),null);
...
return cljs.core.take.cljs$core$IFn$_invoke$arity$2(units,cljs.core.repeat.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(p1__12235_SHARP_)], null)));
});})(squares,units))
,stash);
 ...
 */
obb_rules.auto_deploys.common.split_stash = (function obb_rules$auto_deploys$common$split_stash(lineup,p__12237){
var vec__12239 = p__12237;
var unit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12239,(0),null);
var quantity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12239,(1),null);
var slots = cljs.core.count(cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (vec__12239,unit,quantity){
return (function (p1__12236_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(unit,p1__12236_SHARP_);
});})(vec__12239,unit,quantity))
,lineup));
 ...
 */
obb_rules.auto_deploys.common.build_deploy_action = (function obb_rules$auto_deploys$common$build_deploy_action(player,row,idx,p__12240){
var vec__12242 = p__12240;
var u = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12242,(0),null);
var q = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12242,(1),null);
...
var G__12245 = obb_rules.result.result_board(result);
var G__12246 = player;
return (action.cljs$core$IFn$_invoke$arity$2 ? action.cljs$core$IFn$_invoke$arity$2(G__12245,G__12246) : action.call(null,G__12245,G__12246));
}
});
