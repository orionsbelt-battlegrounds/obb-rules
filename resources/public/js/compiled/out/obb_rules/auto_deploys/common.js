 ...
 */
obb_rules.auto_deploys.common.map_stash_to_units = (function obb_rules$auto_deploys$common$map_stash_to_units(p__12851){
var vec__12853 = p__12851;
var unit_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12853,(0),null);
var quantity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12853,(1),null);
...
return cljs.core.take.cljs$core$IFn$_invoke$arity$2(units,cljs.core.repeat.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(p1__12854_SHARP_)], null)));
});})(squares,units))
,stash);
 ...
 */
obb_rules.auto_deploys.common.split_stash = (function obb_rules$auto_deploys$common$split_stash(lineup,p__12856){
var vec__12858 = p__12856;
var unit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12858,(0),null);
var quantity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12858,(1),null);
var slots = cljs.core.count(cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (vec__12858,unit,quantity){
return (function (p1__12855_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(unit,p1__12855_SHARP_);
});})(vec__12858,unit,quantity))
,lineup));
...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,quantities);
});
/**
 * Builds a deploy action command
 */
obb_rules.auto_deploys.common.build_deploy_action = (function obb_rules$auto_deploys$common$build_deploy_action(player,row,idx,p__12859){
var vec__12861 = p__12859;
var u = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12861,(0),null);
var q = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12861,(1),null);
...
var G__12864 = obb_rules.result.result_board(result);
var G__12865 = player;
return (action.cljs$core$IFn$_invoke$arity$2 ? action.cljs$core$IFn$_invoke$arity$2(G__12864,G__12865) : action.call(null,G__12864,G__12865));
}
});
