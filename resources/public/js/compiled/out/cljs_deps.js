...
goog.addDependency("../obb_rules/logger.js", ['obb_rules.logger'], ['obb_rules.simplifier', 'cljs.core']);
...
goog.addDependency("../obb_rules/actions/strikeback.js", ['obb_rules.actions.strikeback'], ['obb_rules.board', 'obb_rules.actions.direction', 'obb_rules.element', 'cljs.core', 'obb_rules.actions.damage_calculator', 'obb_rules.unit', 'obb_rules.math']);
...
goog.addDependency("../obb_rules/actions/triple_attack.js", ['obb_rules.actions.triple_attack'], ['obb_rules.board', 'obb_rules.actions.direction', 'obb_rules.simplifier', 'obb_rules.element', 'cljs.core', 'obb_rules.actions.damage_calculator', 'obb_rules.unit']);
...
goog.addDependency("../obb_rules/ai/alamo.js", ['obb_rules.ai.alamo'], ['obb_rules.board', 'obb_rules.logger', 'obb_rules.simplifier', 'obb_rules.element', 'obb_rules.evaluator', 'cljs.core', 'obb_rules.result', 'obb_rules.ai.firingsquad', 'obb_rules.actions.move', 'obb_rules.unit', 'obb_rules.math', 'obb_rules.game', 'obb_rules.ai.common', 'obb_rules.laws']);
goog.addDependency("../cljs/core/async/impl/buffers.js", ['cljs.core.async.impl.buffers'], ['cljs.core', 'cljs.core.async.impl.protocols']);
goog.addDependency("../cljs/core/async/impl/dispatch.js", ['cljs.core.async.impl.dispatch'], ['cljs.core', 'cljs.core.async.impl.buffers', 'goog.async.nextTick']);
goog.addDependency("../cljs/core/async/impl/channels.js", ['cljs.core.async.impl.channels'], ['cljs.core.async.impl.dispatch', 'cljs.core', 'cljs.core.async.impl.buffers', 'cljs.core.async.impl.protocols']);
goog.addDependency("../obb_rules/serializer/common.js", ['obb_rules.serializer.common'], ['cljs.core']);
goog.addDependency("../clojure/string.js", ['clojure.string'], ['goog.string', 'cljs.core', 'goog.string.StringBuffer']);
goog.addDependency("../obb_rules/serializer/reader.js", ['obb_rules.serializer.reader'], ['obb_rules.board', 'obb_rules.serializer.common', 'cljs.core', 'obb_rules.result', 'obb_rules.turn', 'obb_rules.actions.deploy', 'obb_rules.game', 'clojure.string', 'obb_rules.game_mode', 'obb_rules.host_dependent']);
...
goog.addDependency("../obb_demo/boardground.js", ['obb_demo.boardground'], ['obb_rules.board', 'obb_rules.element', 'cljs.core', 'obb_rules.result', 'obb_rules.actions.move', 'obb_rules.turn', 'obb_rules.unit', 'obb_rules.game', 'obb_demo.state', 'obb_rules.ai.common', 'obb_rules.laws']);
goog.addDependency("../obb_demo/processor.js", ['obb_demo.processor'], ['obb_rules.ai.alamo', 'obb_rules.simplifier', 'obb_rules.evaluator', 'cljs.core', 'obb_rules.result', 'obb_rules.ai.firingsquad', 'obb_rules.turn', 'obb_rules.math', 'obb_rules.game', 'obb_demo.state', 'obb_rules.stash', 'obb_rules.game_mode']);
goog.addDependency("../obb_demo/views/power_bar.js", ['obb_demo.views.power_bar'], ['obb_demo.boardground', 'obb_rules.evaluator', 'cljs.core', 'obb_rules.result', 'obb_rules.turn', 'obb_demo.processor', 'obb_rules.math', 'obb_rules.game', 'obb_demo.state', 'obb_rules.stash']);
goog.addDependency("../obb_demo/views/many_games.js", ['obb_demo.views.many_games'], ['obb_demo.boardground', 'obb_rules.evaluator', 'cljs.core', 'obb_rules.result', 'obb_rules.turn', 'obb_demo.processor', 'obb_rules.math', 'obb_rules.game', 'obb_demo.state', 'obb_demo.views.power_bar', 'obb_rules.stash']);
goog.addDependency("../obb_rules/serializer/writer.js", ['obb_rules.serializer.writer'], ['obb_rules.board', 'obb_rules.serializer.common', 'cljs.core', 'obb_rules.game', 'clojure.string', 'obb_rules.game_mode']);
goog.addDependency("../obb_demo/views/player.js", ['obb_demo.views.player'], ['obb_rules.serializer.writer', 'obb_rules.ai.alamo', 'obb_rules.simplifier', 'obb_rules.element', 'obb_demo.boardground', 'obb_rules.evaluator', 'cljs.core', 'obb_rules.result', 'obb_rules.ai.firingsquad', 'obb_rules.actions.move', 'obb_rules.turn', 'obb_rules.unit', 'obb_rules.serializer.reader', 'obb_demo.processor', 'obb_rules.math', 'obb_rules.game', 'obb_demo.state', 'obb_demo.views.power_bar', 'obb_rules.stash', 'obb_rules.game_mode', 'obb_rules.laws', 'obb_rules.host_dependent']);
...
goog.addDependency("../obb_demo/views/play.js", ['obb_demo.views.play'], ['obb_rules.serializer.writer', 'obb_demo.boardground', 'obb_rules.evaluator', 'cljs.core', 'obb_rules.result', 'obb_rules.turn', 'obb_demo.processor', 'obb_rules.math', 'obb_rules.game', 'obb_demo.state', 'obb_demo.views.power_bar', 'obb_rules.stash']);
goog.addDependency("../obb_demo/views/units.js", ['obb_demo.views.units'], ['cljs.core', 'obb_rules.unit', 'obb_demo.state']);
goog.addDependency("../obb_demo/views/index.js", ['obb_demo.views.index'], ['obb_demo.views.layout.footer', 'obb_demo.views.player', 'cljs.core', 'obb_demo.views.layout.header', 'obb_demo.views.play', 'obb_demo.views.units', 'obb_demo.state', 'obb_demo.views.many_games']);
...
goog.addDependency("../obb_demo/core.js", ['obb_demo.core'], ['obb_demo.boardground', 'reagent.core', 'cljs.core', 'obb_rules.result', 'obb_rules.turn', 'secretary.core', 'obb_demo.processor', 'obb_demo.routes', 'obb_rules.game', 'obb_demo.state', 'obb_demo.views.index']);
